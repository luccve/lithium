...
portao = Ambiente(312,218, portao_img)
pinheiro = Ambiente(1024, 450, pinheiro_img)
arbusto = Ambiente(1024, 200, arbusto_img)

ambiente_sprites.add(chao)
ambiente_sprites.add(portao)
ambiente_sprites.add(pinheiro)
ambiente_sprites.add(arbusto)


limite = Limite_mov_player(656, 350)
player = Player(x_player, y_player, 0)
nicolau = NPC(301, 314, 0,npc_img)


#ambiente_sprites.add(limite)

obstaculos_sprites.add(limite)
npcs_sprites.add(pinheiro)
npcs_sprites.add(arbusto)
